...
<h2><b><center>ADD Flavour</center></b></h2><br />
...
if(isset($_POST['submit'])){
	...
	$sql1="Select PID from TADDCAKE ORDER BY PID DESC LIMIT 1";
	...
	$sql="Select * from TADDCAKE where PFLAVOUR='$flavour'";
	...
	if($result){
 	...
 	{
		$sql2="insert into TADDCAKE(PID,PFLAVOUR)values('$lastid','$flavour')";

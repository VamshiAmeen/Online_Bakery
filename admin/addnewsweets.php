...
<h2><b><center>ADD NEW SWEETS</center></b></h2><br />
...
if(isset($_POST['submit'])){
	...
	$sql1="Select PID from TADDSWEETS ORDER BY PID DESC LIMIT 1";
	...
	$sql="Select * from TADDSWEETS where PFLAVOUR='$flavour'";
	...
	if($result){
 	...
 	{
		$sql2="insert into TADDSWEETS(PID,PFLAVOUR)values('$lastid','$flavour')";
